  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="index.php"><img src="https://www.dmoe.cc/random.php" title="<?php echo conf('name');?>" alt="<?php echo conf('name');?>" /></a>
      </div>
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav">
              ...
              <ul class="nav nav-subnav">
                <li> <a class="multitabs" href="web_config.php?mod=base">网站配置</a> </li>
                <li> <a class="multitabs" href="web_config.php?mod=indexmk">首页配置</a> </li>
                <li> <a class="multitabs" href="web_config.php?mod=emailset">其他配置</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
              ...
              <ul class="nav nav-subnav">
                ...
                <li> <a class="multitabs" href="wtfk.php">问题反馈</a> </li>
              </ul>
            </li>
            <?php } ?>
          </ul>
        ...
        <div class="sidebar-footer">
          <p class="copyright">Copyright &copy; 2021-2023. <a target="_blank" href="http://<?php echo conf('Url');?>"><?php echo conf('Name');?></a> All rights reserved.</p>
        </div>
      </div>
