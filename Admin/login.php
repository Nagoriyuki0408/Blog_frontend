...
<title>后台登录 - <?php echo conf('SiteName');?> - 后台管理中心</title>
  ...
  <div class="lyear-login-right">
    <form action="login.php" method="post">
      ...
      <footer class="text-center">
        <p class="m-b-0">Copyright © 2021-2023 <a href="http://<?php echo conf('Url');?>"><?php echo conf('SiteName');?></a>. All right reserved</p>
      </footer>
    </form>
